...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 25 15:26:55 2019
@author: saviokay
"""
import dask
import numpy as np
...
plt.title("Level 3 Cloud Fraction Aggregation For One Month With A Subsampling Of 3 [::3,::3]", fontsize = 16)
plt.colorbar()
plt.savefig("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/4/threesub4n_onemonth.png")
cf1 = xr.DataArray(cf)
cf1.to_netcdf("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/4/threesub4n_onemonth.hdf")
t1 = time.time()
total = t1-t0
print(total)
