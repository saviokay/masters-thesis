...
plt.title("Level 3 Cloud Fraction Aggregation For Test Month With No Subsampling [:,:]", fontsize = 16)
plt.colorbar()
plt.savefig("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/NoSub_test_CF.png")
cf1 = xr.DataArray(cf)
cf1.to_netcdf("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/NoSub_test_CF.hdf")
t1 = time.time()
total = t1-t0
print(total)
