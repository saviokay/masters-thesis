...
plt.title("Level 3 Cloud Fraction Aggregation For Test Month With Paratest_1Month withh 16 [:,:]", fontsize = 16)
plt.colorbar()
plt.savefig("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/116Paratest_1Month.png")
cf1 = xr.DataArray(cf)
cf1.to_netcdf("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/116Paratest_1Month.hdf")
t1 = time.time()
total = t1-t0
print(total)
