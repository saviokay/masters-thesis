...
plt.title("Level 3 Cloud Fraction Aggregation For Test Month With Subsampling Of 4[::4,::4]", fontsize = 16)
plt.colorbar()
plt.savefig("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/4test4_CF.png")
cf1 = xr.DataArray(cf)
cf1.to_netcdf("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/4test4_CF.hdf")
t1 = time.time()
total = t1-t0
print(total)
