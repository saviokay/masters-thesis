...
for M03, M06 in zip (M03_files, M06_files):
    ...
    d06 = xr.open_dataset(M06)['Cloud_Mask_1km'][:,:,:].values
    d06CM = d06[::3,::3,0]
    ds06_decoded = (np.array(d06CM, dtype = "byte") & 0b00000110) >> 1
    d03_lat = xr.open_dataset(M03, drop_variables = "Scan Type")['Latitude'][:,:].values
    d03_lon = xr.open_dataset(M03, drop_variables = "Scan Type")['Longitude'][:,:].values
...
plt.title("Level 3 Cloud Fraction Aggregation For Test Month With Subsampling Of 3[::3,::3]", fontsize = 16)
plt.colorbar()
plt.savefig("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/3test3_CF_nosub.png")
cf1 = xr.DataArray(cf)
cf1.to_netcdf("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/3test_CF_nosub.hdf")
t1 = time.time()
total = t1-t0
print(total)
