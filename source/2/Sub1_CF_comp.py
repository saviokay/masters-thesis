...
plt.title("Level 3 Cloud Fraction Aggregation For Test Month With Subsampling Of 0[:,:]", fontsize = 16)
plt.colorbar()
plt.savefig("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/test1_CF_comp.png")
cf1 = xr.DataArray(cf)
cf1.to_netcdf("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/test1_CF_comp.hdf")
t1 = time.time()
total = t1-t0
print(total)
