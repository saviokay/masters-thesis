...
plt.colorbar()
plt.savefig("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/16/threesub16n_onemonth.png")
cf1 = xr.DataArray(cf)
cf1.to_netcdf("/home/savio1/jianwu_common/MODIS_Aggregation/savioexe/test/16/threesub16n_onemonth.hdf")
t1 = time.time()
total = t1-t0
print(total)
